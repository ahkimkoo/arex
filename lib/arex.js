...
const summarizer = new Summarizer(false);
...
exports.summarize = function(content, exptd_len, shingle){
	const summarizer = new Summarizer(shingle);
	return summarizer.summarize(content, Number.isInteger(exptd_len)?exptd_len:120);
}
